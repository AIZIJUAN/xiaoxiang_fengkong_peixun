...
先观察特征之间的相关性，若两个特征存在相关性，根据IV来删除价值低的那个
'''
deleted_index = []
...
'''
多变量分析：VIF
在变量之间相关性分析的基础上，再通过VIF方差膨胀因子分析，进一步观察此时是否存在多重共线性的问题
'''
...
maxPayL6M_Bin_WOE,maxUrateL6M_Bin_WOE,avgUrateL6M_Bin_WOE,avgPayL12M_Bin_WOE,
increaseUrateL12M_Bin_WOE,maxPayL12M_Bin_WOE
的p值大于0.1
单独检验显著性
'''
